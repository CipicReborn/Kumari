...
import com.isartdigital.utils.events.EventTarget;
...
class GameStage extends DisplayObjectContainer
{
	...
	public function resize (): Void {
		...
		eventTarget.dispatchEvent(GameStageEvent.RESIZE,{ width:lWidth, height:lHeight});
	...
	public function addEventListener(pType: String, pListener:Dynamic): Void {
		eventTarget.addEventListener(pType, pListener);
	}
	
	public function removeEventListener(pType: String, pListener:Dynamic): Void {
		eventTarget.removeEventListener(pType, pListener);
	}
